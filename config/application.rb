...
module AACT
  class Application < Rails::Application
    ...
    AACT_BACK_DATABASE_PORT = ENV['AACT_PORT'] || 5432
    AACT_BACK_DATABASE_PASS = ENV['AACT_PASSWORD'] || ''
    AACT_BACK_DATABASE_URL       = "postgres://#{AACT_DB_SUPER_USERNAME}:#{AACT_BACK_DATABASE_PASS}@#{APPLICATION_HOST}:#{AACT_BACK_DATABASE_PORT}/#{AACT_BACK_DATABASE_NAME}"
